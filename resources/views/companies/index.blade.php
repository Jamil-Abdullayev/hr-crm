                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            @can('user_access')
                                            <a href="{{ route('companies.show', $item->id) }}" style="color:white;" class="btn blue text-blue-600 hover:text-blue-900 mb-2 mr-2">View</a>
                                            <a href="{{ route('companies.edit', $item->id) }}" style="color:white;" class="btn orange text-indigo-600 hover:text-indigo-900 mb-2 mr-2">Edit</a>
