                ...
                <form method="post" action="{{ route('developers.update', $data->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            Full-Time <input type="radio" @php if($data->working_type==1){ echo 'checked'; } @endphp name="working_type" id="price" class="form-radio rounded-md shadow-sm mt-1 block"
                                             value="1" />
                            Part-Time <input type="radio" @php if($data->working_type==2){ echo 'checked'; } @endphp name="working_type" id="price" class="form-radio rounded-md shadow-sm mt-1 block "
                                             value="2" />
                        </div>
