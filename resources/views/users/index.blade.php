                                ...
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('users.show', $user->id) }}" style="color: white" class="btn blue text-blue-600 hover:text-blue-900 mb-2 mr-2">View</a>
                                            <a href="{{ route('users.edit', $user->id) }}" style="color: white" class="btn orange text-indigo-600 hover:text-indigo-900 mb-2 mr-2">Edit</a>
